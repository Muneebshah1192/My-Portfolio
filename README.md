# Syed Muneeb Haider Shah — AI & Automation Portfolio

> **AI & Automation Engineer | Full-Stack & 3D Web Developer**  
> BS Information Technology and AI — The University of Chakwal (Expected September 2027)
...
* **Core Domains:** Artificial Intelligence, Machine Learning, Deep Learning, Generative AI, RAG, NLP, Prompt Engineering, MCP
* **Frameworks & Tools:** PyTorch, TensorFlow, Vector Databases, OpenAI API, LangChain, LangGraph, Multi-Agent Orchestration

### 2. AI Automation & Workflow Engineering
* **Automation Tools:** n8n, Make.com, Playwright, Webhooks, API Integrations
* **Pipelines:** Autonomous Agentic workflows, transcription processing, and data scraping pipelines.

### 3. Full-Stack & 3D Web Technologies
* **Frontend & WebGL:** Next.js, React, Three.js, WebGL, React Three Fiber, Tailwind CSS, GLSL, TypeScript
* **Backend & Databases:** Flask, FastAPI, Node.js, Supabase, PostgreSQL, Oracle SQL, MongoDB, Prisma

### 4. General Engineering & Security
* **Languages:** Python, C++, SQL, Java
* **Infrastructure & Security:** Docker, Cybersecurity Fundamentals, Data Engineering, Technical Project Management, Git

---

## 💼 Professional Experience

### **AI & Automation Engineer** | Orbit Digital *(Aug 2026 - Present)*
* Working on real-world AI & automation projects, building AI-powered solutions, LLM applications, intelligent workflows, and full-stack applications.
* Specialized in Generative AI, LLMs, Prompt Engineering, AI Agents, n8n workflow automation, API integrations, and webhooks using Next.js and TypeScript.
...
* **Artificial Intelligence Virtual Internship** — Decodelabs
* **Data Analytics and Business** — DigiSkills.pk
* **Artificial Intelligence Using Python** — DigiSkills.pk
* **Google Cybersecurity Professional Certificate** — Google
* *Plus 24+ additional verified certifications spanning cloud computing, programming, and IT systems.*

---

## ⚙️ Setup and Local Installation Guide

To run or evaluate components of this portfolio locally:
